...
[프로젝트 소개](../README.md) · [원본 저장소](https://github.com/joy-riders/EDA_weather)
...
- 관계 참고 자료: [relation_key.xlsx](references/relation_key.xlsx)

프로젝트의 상세 설명은 위 공통 문서에 통합되어 있습니다.
